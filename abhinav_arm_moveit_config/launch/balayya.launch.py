...
def generate_launch_description():
    ...
    package_name_gazebo = 'abhinav_arm'
    package_name_moveit_config = 'abhinav_arm_moveit_config'
    ...
    urdf_file_path = 'urdf/ros2_control/gazebo/onshape.urdf.xacro'
    srdf_file_path = 'config/onshape.srdf'
    ...
    moveit_config = (
        MoveItConfigsBuilder("onshape", package_name=package_name_moveit_config)
